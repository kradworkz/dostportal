    ...
    <div class="col-md-12">
        <div class="card" :style="{ height: height + 'px' }">
                    ...
                    <table class="table table-centered table-nowrap">
                        ...
                        <tbody>
                            <tr v-for="travel in travels" v-bind:key="travel.id">
                                ...
                                <td class="text-right">
                                    <a data-toggle="tooltip" data-placement="top" title="" data-original-title="View Document" class="mr-3 text-info" @click="action('view',travel)"><i class='bx bx-show'></i></a>
                                    <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Document" class="mr-3 text-warning" @click="action('edit',travel)"><i class='bx bx-edit-alt' ></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row md-3" v-else>
                <travel-calendar v-if="tcv == true" :profile="profile" :modetype="modetype" :traveltype="traveltype" ref="trvlcalendar"></travel-calendar>
                <travel-calendar-travel :modetype="modetype" :profile="profile" :traveltype="traveltype" v-else></travel-calendar-travel>
            </div>

        </div>

    <div class="modal fade exampleModal" id="showEvent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <travel-view :statuses="statuses" :profile="profile" ref="view"></travel-view>
    </div>

    <div class="modal fade exampleModal" id="choose" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <travel-calendar-choose @ch="msg" :modes="modes" :profile="profile" ref="choose"></travel-calendar-choose>
    </div>
